...
const STAGES = [
  ...
  { id: 'submitted', label: 'Submitted', color: 'bg-orange-500', icon: Send },
...
export default function Pipeline() {
  ...
  const processAll = async () => {
    ...
    const toProcess = items.filter(i => i.stage !== 'awarded' && i.stage !== 'submitted')
  ...
  const remainingCount = items.filter(i => i.stage !== 'awarded' && i.stage !== 'submitted').length
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex gap-4 mb-8">
        <button
          onClick={() => processItem(items.find(i => i.stage !== 'awarded' && i.stage !== 'submitted'))}
